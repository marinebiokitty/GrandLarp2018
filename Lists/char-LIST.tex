...
\NEW{PC}{\cLouis}{
\s\MYname{Prof. Caduceus Sanders}
\s\MYplayer{Louis Wasserman (he/him)}
\s\MYsex{\male}
\s\MYrole{Fairest (Spring)}
}
\NEW{PC}{\cMichael}{
\s\MYname{Prof. Michael Deklan}
\s\MYplayer{Michael Abercrombie (he/him)}
\s\MYsex{\male}
\s\MYrole{Human}
}
\NEW{PC}{\cAmy}{
\s\MYname{Dr. Jacqueline Harrison}
\s\MYplayer{Amy Russo (she/her)}
\s\MYsex{\female}
\s\MYrole{Fetch (Summer)}
}
\NEW{PC}{\cMatt}{
\s\MYname{Prof. Markus Whitmore}
\s\MYplayer{Matt Fisher (he/him)}
\s\MYsex{\male}
\s\MYrole{Darkling (Autumn)}
}
\NEW{PC}{\cKate}{
\s\MYname{Hypatia Leabhar}
\s\MYplayer{Kate Hill (she/her)}
\s\MYsex{\female}
\s\MYrole{Elemental (Winter)}
}
\NEW{PC}{\cBetty}{
\s\MYname{Sabrina Chen}
\s\MYplayer{Betty Bong (she/her)}
\s\MYsex{\female}
\s\MYrole{Beast (Spring)}
}
\NEW{PC}{\cRachael}{
\s\MYname{Emerald}
\s\MYplayer{Rachael Monosson (she/her)}
\s\MYsex{\female}
\s\MYrole{Beast (Spring)}
}
\NEW{PC}{\cYvonne}{
\s\MYname{Arcy Keen}
\s\MYplayer{Yvonne Kung (she/her)}
\s\MYsex{\female}
\s\MYrole{Fairest (Spring)}
}
\NEW{PC}{\cDana}{
\s\MYname{Laura Doe}
\s\MYplayer{Dana Murphy (she/her)}
\s\MYsex{\female}
\s\MYrole{Elemental (Spring)}
}
\NEW{PC}{\cPeter}{
\s\MYname{\vspace{0.7in}}
\s\MYplayer{Peter Lofgren (he/him)}
\s\MYsex{\male}
\s\MYrole{Ogre (Summer)}
}
\NEW{PC}{\cDonald}{
\s\MYname{\vspace{0.7in}}
\s\MYplayer{Donald Gavreau (he/him)}
\s\MYsex{\male}
\s\MYrole{Wizened (Summer)}
}
\NEW{PC}{\cKyle}{
\s\MYname{Jack Hirsch}
\s\MYplayer{Kyle Shiells (he/him)}
\s\MYsex{\male}
\s\MYrole{Ogre (Summer)}
}
\NEW{PC}{\cMegan}{
\s\MYname{Tanya Dubai}
\s\MYplayer{Megan Fisher (she/her)}
\s\MYsex{\female}
\s\MYrole{Elemental (Summer)}
}
\NEW{PC}{\cAbby}{
\s\MYname{Scarlett Gellar}
\s\MYplayer{Abigail Stone (she/her)}
\s\MYsex{\female}
\s\MYrole{Fairest (Autumn)}
}
\NEW{PC}{\cAmanda}{
\s\MYname{Ilona Kay}
\s\MYplayer{Amanda Stowers (she/her)}
\s\MYsex{\female}
\s\MYrole{Wizened (Autumn)}
}
\NEW{PC}{\cMash}{
\s\MYname{Saturn}
\s\MYplayer{Mashbayar Tugsbayar (she/her)}
\s\MYsex{\female}
\s\MYrole{Darkling (Autumn)}
}
\NEW{PC}{\cVictor}{
\s\MYname{Justice Collins}
\s\MYplayer{Victor Felton (he/him)}
\s\MYsex{\male}
\s\MYrole{Wizened (Autumn)}
}
\NEW{PC}{\cMark}{
\s\MYname{Isaac North}
\s\MYplayer{Mark Stone (he/him)}
\s\MYsex{\male}
\s\MYrole{Elemental (Winter)}
}
\NEW{PC}{\cGhost}{
\s\MYname{\vspace{0.7in}}
\s\MYplayer{Daniel Whalen (he/him)}
\s\MYsex{\male}
\s\MYrole{Elemental (Winter)}
}
\NEW{PC}{\cSarah}{
\s\MYname{Trinity Lovelace}
\s\MYplayer{Sarah Terman (she/her)}
\s\MYsex{\female}
\s\MYrole{Darkling (Winter)}
}
\NEW{PC}{\cVivian}{
\s\MYname{Annie Parrish}
\s\MYplayer{Vivian Halbany (she/her)}
\s\MYsex{\female}
\s\MYrole{Darkling (Winter)}
}
\NEW{PC}{\cMarie}{
\s\MYname{Nanashi}
\s\MYplayer{Marie Chelberg (she/her)}
\s\MYsex{\female}
\s\MYrole{Human}
}
\NEW{PC}{\cSam}{
\s\MYname{Trench}
\s\MYplayer{Sam Tillis (he/him)}
\s\MYsex{\male}
\s\MYrole{Human}
}
\NEW{PC}{\cShannon}{
\s\MYname{Atticus "Attie" Finch}
\s\MYplayer{Shannon Thomson (she/her)}
\s\MYsex{\female}
\s\MYrole{Human}
}
...
\NEW{PC}{\cSong}{
\s\MYname{Sam Yang}
\s\MYplayer{Song Wang (he/him)}
\s\MYsex{\male}
\s\MYrole{Human}
}
\NEW{PC}{\cBen}{
\s\MYname{Alex Hunt}
\s\MYplayer{Benjamin Shaya (he/him)}
\s\MYsex{\male}
\s\MYrole{Fetch}
}
