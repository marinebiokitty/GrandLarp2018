...
\s\MYsex{\male}
\s\MYrole{Changeling (Autumn)}
}
\NEW{PC}{\cKate}{
\s\MYname{Hypatia Leabhar}
\s\MYplayer{Kate Hill (she/her)}
\s\MYsex{\female}
\s\MYrole{Changeling (Winter)}
}
\NEW{PC}{\cBetty}{
...
\NEW{PC}{\cPeter}{
\s\MYname{I Haven't Told Them Yet}
\s\MYplayer{Peter Lofgren (he/him)}
\s\MYsex{\male}
\s\MYrole{Changeling (Summer)}
}
\NEW{PC}{\cDonald}{
\s\MYname{I Haven't Told Them Yet}
