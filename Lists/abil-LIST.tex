...
\NEW{Abil}{\aWinter}{
  \s\MYname	{Renegotiating the Covenant with Fog:}
  \s\MYtext	{As the Winter Speaker and spiritual successor to the no longer forgotten Winter Court founder Chione Wax, you or your designated representative can attempt to summon the Fog and renegotiate your court’s contract. In order to do this, you must go to the Sculpture Garden and conduct a ritual which includes a suitable offering. You are free to make up the specifics of the ritual, just let the GMs know if you wish to do this. You can attempt to renegotiate the Covenant with Fog no more than once/day. {\bf Each attempt increases your Psi Score by 3.}}
  \s\MYeffect	{I talk to the Fog}
  }
