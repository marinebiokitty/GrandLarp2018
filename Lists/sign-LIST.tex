...
\begin{changemargin}{1cm}{1cm}
Go to the library and use the research mechanic to answer the specific question: ``How can we communicate with the fog?'' In the notes section, include information to the effect that you've seen the relevant sculpture in the sculpture garden.
\end{changemargin}
